/** Arduino, ESP32, C/C++ ************************************* fs_stream.h ***
 * 
 *             Обеспечить передачу потоков изображений от контроллера в браузер 
 *                   по локальной сети и собственной сети контроллера ESP32-CAM
 *                                                     
