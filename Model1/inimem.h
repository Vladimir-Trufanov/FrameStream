...
int start_record = 0;            // флаг запуска записи очередного видео файла
...
// Определяем переменные и буферы для работы со снятым кадром
// (размер буферов для кадров определяется после конфигурирования камеры и 
